...
return (
    <Dialog.Root open={open} onOpenChange={handleCloseRequest}>
        <Dialog.Content style={{ maxWidth: 500 }}>
            ...
            </Dialog.Description>                <Flex direction="column" gap="4">
                <Box>
                    ...
                    <Select.Root
                        ...
                        onValueChange={(value) => setManager(parseInt(value))}
                    >
                        <Select.Trigger
                    ...
                    <Flex gap="2" wrap="wrap">
                        {[
                            { id: 1, icon: LuIcons.LuAArrowDown },
                            { id: 2, icon: LuIcons.LuAArrowUp },
                            { id: 3, icon: LuIcons.LuActivity }
                        ].map(({ id, icon }) => (
                            <Box
                                key={id}
                                ...
                                style={{
                                    cursor: 'pointer',
                                    border: iconId === id ? '2px solid var(--accent-9)' : '2px solid transparent',
                                    borderRadius: '4px',
                                    padding: '8px',
                                    backgroundColor: iconId === id ? 'var(--accent-3)' : 'transparent'
                                }}
                            >
                                <img
                                    src={icon}
